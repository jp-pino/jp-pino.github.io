...
<div class="flex flex-col md:flex-row md:-mx-12">
    <div class="md:basis-9/12 md:pr-6">
        ...
        <div class="w-full mb-6">
            ...
            <img src="<?php echo e($featuredPost->cover_image); ?>" alt="<?php echo e($featuredPost->title); ?> cover image" class="mb-6 mx-auto">
            <?php endif; ?>
    ...
    <div class="md:basis-3/12">
        <div class="border-2 rounded-md p-4">
            ...
            <div id="project-list" class="flex flex-col items-center h-[50vh] overflow-y-auto">
                <?php echo $__env->make('projects', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('_layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jp.pinob/Projects/Portfolio/jp-pino.github.io/source/index.blade.php ENDPATH**/ ?>